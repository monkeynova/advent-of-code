...
// packet are represented as binary with the most significant bit first.
// For example, a version encoded as the binary sequence 100 represents
// the number 4.
//
...
// bit. These groups of five bits immediately follow the packet header.
...
// group, keep reading) and contain the first four bits of the
// number, 0111.
//
...
// they only have a single sub-packet, their value is the value of
// the sub-packet.
//
