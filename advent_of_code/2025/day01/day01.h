#ifndef ADVENT_OF_CODE_2025_DAY01_H
#define ADVENT_OF_CODE_2025_DAY01_H

#include "advent_of_code/advent_day.h"

namespace advent_of_code {

class Day_2025_01 : public AdventDay {
 public:
  virtual std::string_view title() const override { return "Day 1: ???"; }

  virtual std::string_view test_file() const override {
    return "advent_of_code/2025/day01/day01.test";
  }
...
#endif  // ADVENT_OF_CODE_2025_DAY01_H