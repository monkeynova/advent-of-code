...
numbered `0` through `10006`. The deck must be new - they're still in *factory
...
from the leftmost card again. Continue this process until you run out
of cards.
...
the top card, and so on, until the rightmost card ends up at the bottom
of the deck.
...
with merely a single deck of cards. You ask every 3D printer on the
ship to make you some more cards while you check on the ship repairs.
While reviewing the work the droids have finished so far, you think you
see [Halley's Comet](https://en.wikipedia.org/wiki/Halley%27s_Comet)
fly past!
