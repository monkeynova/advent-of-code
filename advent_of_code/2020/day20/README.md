...
from the example above, you get `1951 * 3079 * 2971 * 1171` = *`20899048083289`*.
...
image before it's oriented correctly to find sea monsters. In the above
image, *after flipping and rotating it* to the appropriate orientation,
