...
absl::StatusOr<int64_t> FindMinPartition(const WeightsSet& weights_set) {
  int total_weight = 0;
...
absl::StatusOr<std::vector<std::string>> Day24_2015::Part1(
  ...
  return IntReturn(FindMinPartition(weights_set));
}

absl::StatusOr<std::vector<std::string>> Day24_2015::Part2(
    absl::Span<absl::string_view> input) const {
