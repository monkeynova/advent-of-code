...
pack goes flying overhead. Monkeys are playing [Keep Away](https://en.wikipedia.org/wiki/Keep_away)
...
causes your worry level to be *divided by three* and rounded down to
the nearest integer.
...
*    Monkey 0 inspected items 101 times.*    Monkey 1 inspected items 95 times.
    Monkey 2 inspected items 7 times.*    Monkey 3 inspected items 105 times.*    
...
after 10000 rounds. Using the same example above:
    ...
    == After round 10000 ==*    Monkey 0 inspected items 52166 times.*    Monkey 1 inspected items 47830 times.
