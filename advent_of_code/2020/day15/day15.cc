...
// turn, 4) and the turn number of the time it was most recently
// spoken before then (turn 1). Thus, the 5th number spoken is 4 - 1,
// 3.
//
// * Turn 6: The last number spoken, 3 had also been spoken before,
// most recently on turns 5 and 2. So, the 6th number spoken is 5 - 2,
// 3.
//
