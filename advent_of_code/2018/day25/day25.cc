...
// ----------------
//
// A small glowing portal opens above the mug you prepared and just
// enough hot chocolate streams in to fill it. You suspect the reindeer
// has never encountered hot chocolate before, but seems to enjoy it
